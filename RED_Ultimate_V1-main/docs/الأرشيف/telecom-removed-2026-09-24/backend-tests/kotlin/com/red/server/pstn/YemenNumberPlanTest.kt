...
class YemenNumberPlanTest {
    ...
    @Test
    fun `isDialableMobile is strict on prefix and length`() {
        assertTrue(YemenNumberPlan.isDialableMobile("771234567")) // يمن موبايل
        assertTrue(YemenNumberPlan.isDialableMobile("722123456")) // سبأفون عدن
        assertTrue(YemenNumberPlan.isDialableMobile("780488700")) // رقم الاختبار الحي
        // ثغرة الطول القديمة مغلقة: 9 خانات ببادئة مجهولة تُرفض
        assertEquals(false, YemenNumberPlan.isDialableMobile("721234567"))
        assertEquals(false, YemenNumberPlan.isDialableMobile("791234567"))
        // الطول غير 9 يُرفض
        assertEquals(false, YemenNumberPlan.isDialableMobile("77123456"))
        assertEquals(false, YemenNumberPlan.isDialableMobile("967771234567"))
    }
