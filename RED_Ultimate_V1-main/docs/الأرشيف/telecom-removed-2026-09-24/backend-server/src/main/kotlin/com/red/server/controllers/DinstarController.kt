...
class DinstarController(
    ...
    /** ينهي المكالمة الإدارية ويحرر منفذ GSM بنفس مسار الإنهاء الموثوق. */
    @PostMapping("/calls/{callId}/hangup")
    fun hangupAdminCall(@PathVariable callId: String, authentication: Authentication): ResponseEntity<Any> =
