...
object DinstarApiContract {
    ...
    object Path {
        ...
        // ── تكوين الجهاز ──
        const val GET_CONFIG = "/api/get_config"
        const val SET_CONFIG = "/api/set_config"
        const val GET_GLOBAL_PARAMS = "/api/get_global_params"
        const val GET_PARAMETERS = "/api/get_parameters"
        const val GET_SYSTEM_INFO = "/api/get_system_info"
        const val GET_NETWORK = "/api/get_network"
        const val SET_NETWORK = "/api/set_network"
        const val GET_SIP = "/api/get_sip"
        const val SET_SIP = "/api/set_sip"
        const val GET_DID = "/api/get_did"
        const val SET_DID = "/api/set_did"
        const val GET_ROUTE = "/api/get_route"
        const val SET_ROUTE = "/api/set_route"
        const val GET_SMSC = "/api/get_smsc"
        const val SET_SMSC = "/api/set_smsc"
        const val GET_BILLING = "/api/get_billing"
    }
    ...
    val METHODS: Map<String, Method> = mapOf(
        ...
        Path.GET_CONFIG to Method.GET,
        Path.SET_CONFIG to Method.POST,
        Path.GET_GLOBAL_PARAMS to Method.GET,
        Path.GET_PARAMETERS to Method.GET,
        Path.GET_SYSTEM_INFO to Method.GET,
        Path.GET_NETWORK to Method.GET,
        Path.SET_NETWORK to Method.POST,
        Path.GET_SIP to Method.GET,
        Path.SET_SIP to Method.POST,
        Path.GET_DID to Method.GET,
        Path.SET_DID to Method.POST,
        Path.GET_ROUTE to Method.GET,
        Path.SET_ROUTE to Method.POST,
        Path.GET_SMSC to Method.GET,
        Path.SET_SMSC to Method.POST,
        Path.GET_BILLING to Method.GET
    )
    ...
    object Config {
        /** مسار النسخ الاحتياطي — يُرجع خريطة بكل إعدادات الجهاز. */
        fun backupConfig(): Map<String, Any?> = emptyMap()

        /** استعادة التكوين من خريطة النسخ الاحتياطي. */
        fun restoreConfig() {}

        /** لقطة التكوين المحفوظة. */
    ...
    object Network {
        ...
        /** قناع الشبكة الفرعية. */
        const val FIELD_NETMASK = "netmask"
        /** بوابة الافتراضي. */
        const val FIELD_GATEWAY = "gateway"
        /** خادم DNS الأول. */
        const val FIELD_DNS1 = "dns1"
        /** خادم DNS الثاني. */
        const val FIELD_DNS2 = "dns2"
        /** أسماء المضيف. */
        const val FIELD_HOSTNAME = "hostname"
        /** حالة الواجهة الشبكية. */
        ...
        /** اتصال الإنترنت. */
        const val FIELD_INTERNET = "internet"
        /** إعادة تشغيل الشبكة عند التطبيق. */
        const val FIELD_REBOOT = "reboot"
    }
    ...
    object Sip {
        ...
        /** معرّف تسجيل SIP. */
        const val FIELD_REG_ID = "reg_id"
        /** حالة التسجيل. */
        const val FIELD_REG_STATUS = "reg_status"
        /** فترة التسجيل بالثواني. */
        const val FIELD_REG_PERIOD = "reg_period"
        /** رقم الهاتف المحلي. */
        const val FIELD_LOCAL_NUMBER = "local_number"
        /** اسم المزوّد. */
        const val FIELD_PROVIDER = "provider"
        /** تعريف الترحيل. */
        const val FIELD_OUTBOUND_PROXY = "outbound_proxy"
        /** حالة TLS. */
        const val FIELD_TLS = "tls"
        /** منفذ TLS. */
        const val FIELD_TLS_PORT = "tls_port"
        /** حالة الضوضاء الصوتية. */
        const val FIELD_DTMF = "dtmf"
        /** حجم الحزمة الصوتية. */
    ...
    object Route {
        /** معرّف المسار. */
        const val FIELD_ROUTE_ID = "route_id"
        /** بادئة الرقم الموجهة. */
        ...
        /** حالة المسار (نشط/غير نشط). */
        const val FIELD_ENABLED = "enabled"
        /** اسم المسار. */
        const val FIELD_NAME = "name"
        /** نوع التوجيه. */
        const val FIELD_TYPE = "type"
        /** زمن الانتظار قبل المحاولة التالية. */
        const val FIELD_RETRY_DELAY = "retry_delay"
    }
    ...
    object Billing {
        /** الرصيد الإجمالي. */
        const val FIELD_CREDIT = "credit"
        /** الرصيد الشهري. */
        const val FIELD_MONTHLY_CREDIT = "monthly_credit"
        /** الرصيد اليومي. */
        const val FIELD_DAILY_CREDIT = "daily_credit"
        /** زمن المكالمات المتبقي يوميًا. */
        const val FIELD_DAILY_CALL_TIME = "daily_call_time"
        /** زمن المكالمات المتبقي ساعةً. */
        const val FIELD_HOURLY_CALL_TIME = "hourly_call_time"
        /** عدد الاتصالات المتبقية يوميًا. */
        const val FIELD_DAILY_CONNECTED = "daily_connected"
        /** تعيين الفوترة على الجهاز. */
        const val FIELD_BILLING_SETTING = "billing_setting"
        /** نوع الفوترة. */
        const val FIELD_BILLING_TYPE = "billing_type"
    }
    ...
    object Cdr {
        ...
        const val INSERT_SQL: String =
            """INSERT INTO dinstar_cdr
                   (gateway_id, call_id, port_index, start_time, answer_time, duration_seconds,
