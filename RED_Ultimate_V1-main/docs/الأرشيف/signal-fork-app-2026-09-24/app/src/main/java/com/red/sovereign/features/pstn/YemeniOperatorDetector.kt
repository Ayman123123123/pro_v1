 ...
 * | 10x     | Yemen4G (عرض فقط) |
 *
 * المطابقة الثلاثية (722) أولاً ثم الثنائية — نسخة طبق الأصل من
 * YemenNumberPlan.classify(). البادئات 72/74/75/76 غير مخصصة.
 */
object YemeniOperatorDetector {
    ...
    /** هل الرقم محمول يمني صالح؟ البادئة الثلاثية إلزامية — لا ثغرة طول. */
