...
class SfuTicketAuthorizationTest {
    ...
    private val signaling: ConferenceWebSocketHandler = mock()
    private val controller = SfuTicketController(users, groups, jwt, signer, activeCalls, conference, live, signaling)
