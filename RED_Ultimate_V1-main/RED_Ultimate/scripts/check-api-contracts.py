...
ALLOWED = {
    "CreateStoryRequest": (
        {"backgroundColor", "durationMs", "mediaType"},
        "حقول عرض محلية للقصص النصّية والصوتية؛ الخادم يخزّن mediaType "
        "ضمن الوسيط نفسه ولا يقرأ الباقي. تُرسل ويتجاهلها — راجَعتُ "
        "StoryService.create فلا يلمسها.",
    ),
    "PostMedia": (
