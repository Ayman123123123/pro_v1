...
CREATE TABLE IF NOT EXISTS telecom_gateways (
  id TEXT PRIMARY KEY,
  name TEXT NOT NULL,
  vendor TEXT NOT NULL DEFAULT 'DINSTAR',
  model TEXT NOT NULL,
  host TEXT NOT NULL,
...
function seedIfEmpty() {
  ...
  // ── أسطول بوابات DINSTAR ──
  // جهازان لإثبات أن اللوحة والتوجيه يتعاملان مع أكثر من بوابة:
  // ‎-8G يعمل بـ GSM و‎-8T بـ LTE/VoLTE، وثالث معطّل لاختبار الاستبعاد.
