...
export default function MediaCenter() {
  return (
    <div>
      ...
      <Typography.Text type="secondary">mediasoup SFU + WebRTC — مدموج من MediaTab القديمة (داخل MasterLayout) — الآن صفحة مستقلة بالشكل الجديد — بيانات حية</Typography.Text>
