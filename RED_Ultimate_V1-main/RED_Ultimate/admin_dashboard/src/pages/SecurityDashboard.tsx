...
/**
 * 🛡️ Security Dashboard (SecurityCenter)
 * Merged from SecurityTab + PstnAccessTab.
 * Provides Kill Switch, Remote Wipe, and PSTN Access Management.
 */
  ...
  return (
    <Space direction="vertical" size="large" style={{width:'100%'}}>
      <div>
        ...
        <Typography.Text type="secondary">Kill Switch + مسح عن بُعد + صلاحيات PSTN + سجل التدقيق — بيانات حقيقية</Typography.Text>
      </div>
          ...
          },
          {
            ...
            children: (
              <Card title="صلاحيات الاتصال عبر DINSTAR — التحكم بالرصيد">
                <Typography.Paragraph>لا يحصل أي حساب على رصيد الشريحة تلقائياً. حدد صلاحية وعدداً يومياً لكل مستخدم معتمد.</Typography.Paragraph>
