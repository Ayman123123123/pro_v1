...
class LiveStreamService : Service(), WebRtcEngine.Events, MeshRtcSession.Events, LiveStreamSignalingClient.Listener {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        when (intent?.action) {
            ...
            ACTION_START -> {
                ...
                streamPassword = intent.getStringExtra(EXTRA_PASSWORD)?.takeIf(String::isNotBlank)
    ...
    private suspend fun registerBroadcaster(): Boolean {
        ...
        val payload = org.json.JSONObject()
            ...
            .apply { streamPassword?.let { put("password", it) } }
            .toString()
    ...
    private suspend fun joinAsViewer(): Boolean {
        ...
        val payload = org.json.JSONObject().apply { streamPassword?.let { put("password", it) } }.toString()
    ...
    private fun showIncomingLiveStreamNotification(streamId: String, userId: String, broadcasterName: String) {
        ...
        ServiceCompat.startForeground(this, 7403, notif, ServiceInfo.FOREGROUND_SERVICE_TYPE_PHONE_CALL)
    }
    ...
    companion object {
        ...
        const val EXTRA_PRIVATE = "stream_private"
        ...
        fun start(
            ...
            val intent = Intent(context, LiveStreamService::class.java).apply {
                ...
                password?.takeIf(String::isNotBlank)?.let { putExtra(EXTRA_PASSWORD, it) }
            }
            ContextCompat.startForegroundService(context, intent)
        }
