...
/**
 * كاشف المشغل اليمني - حقيقي كامل Material3 2026
 * مزامن مع Backend YemenNumberPlan (المصدر الوحيد للحقيقة)
 ...
 * - 770-789 YemenMobile
 * - 10x Yemen4G
 * يعمل على الشبكة المحلية وكل الشبكات
 */
...
object YemeniOperatorDetector {
    ...
    private val OPERATORS_3: Map<String, OperatorInfo> = mapOf("722" to SABAFON.copy(prefix2 = "722"))
    ...
    fun classify(raw: String): OperatorInfo? {
        ...
        if (local.length >= 3) { OPERATORS_3[local.substring(0, 3)]?.let { return it } }
