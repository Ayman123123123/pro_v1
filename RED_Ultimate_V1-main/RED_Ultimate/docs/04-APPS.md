...
أربع وجهات: المنشورات، المحادثات، إنشاء، المكالمات الموحدة. Feed/following/Yemen/posts والمجموعات والحالات ورفع الوسائط موجودة بمستويات متفاوتة. أي engine غير موصول يجب أن يبقى disabled.
...
واحد. دُمج ما يفيد منهما في `red-app` وحُذفا. أبرز ما نُقل: 20 عملية هاتفية (USSD، إدارة المنافذ، الرسائل الواردة،
تحويل المكالمات — حُذفت لاحقًا في المرحلة 8 بإلغاء نطاق PSTN/Yemen)،
